...
public class FXMLProjectManagerListController implements Initializable {
    ...
    private void configureTable(){
        colManagerName.setCellValueFactory(new PropertyValueFactory<>("firstName")); // Simplificado por ahora
    ...
    public void btnCancel(ActionEvent actionEvent) {
        // De acuerdo al flujo del CU-15, cancelar aquí nos regresa a la selección de proyecto.
