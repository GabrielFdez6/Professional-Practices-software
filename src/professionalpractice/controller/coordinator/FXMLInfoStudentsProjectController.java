...
public class FXMLInfoStudentsProjectController implements Initializable {
    ...
    public void btnCancel(ActionEvent actionEvent) {
        try {
            if (Utils.showConfirmationAlert("Salir de la proyectos", "¿Estás seguro que quieres cancelar?", "Se cerrarán todas las ventanas abiertas.")) {
    ...
    public void btnAssign(ActionEvent actionEvent) {
        ...
        if (Utils.showConfirmationAlert("Confirmar Asignación", confirmationMessage, "Se cerrarán todas las ventanas abiertas.")) {
            try {
